...
{
  /// <summary>
  ///   Interaction logic for ProgrammerCalculatorControl.xaml
  /// </summary>
  public partial class ProgrammerCalculatorControl : UserControl
  {
    ...
    public ProgrammerCalculatorControl(MemoryClass memoryclass)
    {
      InitializeComponent();
    ...
    public void UpdateDisplay()
    {
      ...
      labelBinNumber.Text = Convert.ToString(Convert.ToInt32(numberClass.NumberValue), 2);
      labelHexNumber.Text = Convert.ToInt32(numberClass.NumberValue).ToString("X");
      labelOctNumber.Text = Convert.ToString(Convert.ToInt32(numberClass.NumberValue), 8);
      labelDecNumber.Text = (numberClass.NumberValue / 100).ToString(CultureInfo.InvariantCulture);
    }
  }
}